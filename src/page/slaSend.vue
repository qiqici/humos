<template>
    <section  class="contentBox">
             <div>
                <Row>
                    <i-col span="5" push="1">
                       <i-select :model.sync="carStatus" v-model="carStatusV1"
                    ...
                    <i-col span="5" style="margin-left:30px;">
                       ...
                       :placeholder="carStatusV2" class="inputWdth"></i-input>
                    </i-col>
                </Row>
                 <Row class="mt50">
                    <i-col span="5" push="1">
                ...
                <Row class="mt50">
                    ...
                    <i-col span="5" style="margin-left:30px;">
                       ...
                       placeholder="请输入执行次数" class="inputWdth"></i-input>
                    </i-col>
                </Row>
                 <Row class="mt50">
                    <i-col span="5" push="1">
                    ...
                    <i-col span="5" style="margin-left:30px;">
                       ...
                       placeholder="请输入间隔时间" class="inputWdth"></i-input>
                    </i-col>
                    <i-col span="5" pull="2">
                      <Button>分钟</Button>
                    </i-col>
...
export default {
  ...
  methods: {
    ...
    slaSwitchV1() {
      console.log();
      myRequestApi.slaSendPlate({
        curlUrl: 'http://mos-cspm-exp-radio.uatapps.aliocp.csvw.com',
        exeCount: 1,
        intervalTime: 1,
        keyword: 'BVWTDMW0B19061124',
        reqType: 'vin',
        serviceCode: 'mos-cspm-exp-radio',
        // curlUrl: 'ssfsdfsdf',
        // exeCount: 1,
        // intervalTime: 1,
        // keyword: 'BVWTDMW0B19061124',
  ...
  watch: {
    carStatusV1(val, oldVal) {
      console.log(val, oldVal);
      if (val === '1') {
        this.carStatusV2 = '请输入vin号';
      }
      if (val === '2') {
        this.carStatusV2 = '请输入车牌号';
      }
    },
  },
};
