    ...
    <section  class="contentBox">
             <div>
                <Row>
                    ...
                    <i-col span="6" push="1">
                        到： <Date-picker type="date" :options="endDate"
                    ...
                    <i-col span="6">
                        状态：  <i-select :model.sync="carStatus"
                 ...
                 <Row class="mt50">
                    <i-col span="6"  offset="1" pull="1">
                        VIN： <i-input :value.sync="Car_owner_information.vinNum"
                     ...
                     <i-col span="6" pull="1">
                        车主姓名：<i-input :value.sync="Car_owner_information.userName"
                        placeholder="请输入车主姓名" class="inputWdth"></i-input>
                    </i-col>
                    <i-col span="5" pull="1">
                        车牌号码：<i-input :value.sync="Car_owner_information.carId"
...
export default {
  ...
  methods: {
    ...
    confirm() {
      myRequestApi.slaViewPlate({
        endTime: '2020-01-21T06:07:07.439Z',
        pageIndex: 0,
        pageSize: 10,
        plateNo: 'string',
        serviceCode: 'string',
        slaId: 'string',
        startTime: '2020-01-21T06:07:07.439Z',
        stats: 'string',
        vin: 'string',
      }).then((res) => {
